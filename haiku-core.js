...
(function (root, factory) {
  ...
  const VOCAB = {
    ...
    "be": { syllables: 1, type: "IGNORE" }, 
    "done": { syllables: 1, type: "IGNORE" }, "gently": { syllables: 2, type: "IGNORE" },
    "go": { syllables: 1, type: "IGNORE" },
    "is": { syllables: 1, type: "IGNORE" }, "it": { syllables: 1, type: "IGNORE" },
    "how": { syllables: 1, type: "IGNORE" },
    "loud": { syllables: 1, type: "IGNORE" },
    "me": { syllables: 1, type: "IGNORE" },
    ...
    "sir": { syllables: 1, type: "IGNORE" },
    "suddenly": { syllables: 3, type: "IGNORE" }, "telling": { syllables: 2, type: "IGNORE" },
    "than": { syllables: 1, type: "IGNORE" }, "the": { syllables: 1, type: "IGNORE" },
    "this": { syllables: 1, type: "IGNORE" }, 
    "user": { syllables: 2, type: "IGNORE" }, "way": { syllables: 1, type: "IGNORE" },
    "you": { syllables: 1, type: "IGNORE" },
